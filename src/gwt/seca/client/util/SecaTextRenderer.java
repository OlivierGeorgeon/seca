 ...
 * This class is inspired from TextRenderer and modifier in method 'prepareDraw'
 */

public class SecaTextRenderer {
	 ...
	 * @param canvasWidget
	 */
	public SecaTextRenderer(Surface3D canvasWidget) {
	 ...
	 */
	public SecaTextRenderer(Surface3D canvasWidget, int width, int height) {
